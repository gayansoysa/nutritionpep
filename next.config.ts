...
const nextConfig: NextConfig = {
  ...
  images: {
    domains: [
      ...
      'ndb.nal.usda.gov', // USDA images
      'www.fatsecret.com', // FatSecret images
      'edamam-product-images.s3.amazonaws.com', // Edamam images
      'calorieninjas.com', // CalorieNinjas images (if any)
    ],
