...
async function applyMigration() {
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, '..', 'supabase', 'migrations', '20241201000000_external_api_integration.sql');
    ...
    console.log('Testing table creation by inserting default configurations...');
    ...
    if (testError) {
      ...
      console.log('✅ Successfully read configurations:', testConfigs?.length || 0, 'configs');
