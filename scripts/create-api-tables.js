...
async function createTables() {
  ...
  try {
    ...
    if (readError) {
      console.log(
        "Table does not exist or has permission issues:",
        readError.message
      );
      console.log(
      ...
      console.log(
        "Please go to your Supabase project dashboard > SQL Editor and run the migration file:"
      );
      console.log(
    ...
    console.log(
      "You can now visit http://localhost:3001/admin/external-apis to manage your APIs"
    );
  } catch (error) {
