...
const foodFormSchema = z.object({
  ...
  source: z.enum(["curated", "usda", "openfoodfacts"]).default("curated"),
...
const defaultServingSize = { name: "100g", grams: 100 };
...
export default function NewFoodPage() {
  ...
  const form = useForm<any>({
    ...
    defaultValues: {
      ...
      source: "curated",
      verified: false,
      serving_sizes: [defaultServingSize],
      nutrients_per_100g: defaultNutrients,
    },
  });
